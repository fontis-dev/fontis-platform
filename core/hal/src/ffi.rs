...
#[no_mangle]
pub extern "C" fn hal_block_enumerate(result: *mut *mut c_char, result_len: *mut usize) -> i32 {
...
#[no_mangle]
pub extern "C" fn hal_tpm_read_pcr(index: u32, result: *mut *mut c_char) -> i32 {
...
#[no_mangle]
pub extern "C" fn hal_free_string(s: *mut c_char) {
    if !s.is_null() {
        unsafe {
